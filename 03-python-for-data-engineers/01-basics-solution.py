...
# Solution: output will be 10 because it does not allow duplicates
...
# Solution: output will be an empty list
...
de = DataExtractor(some_value="Some value here")
de.get_connection()
de.some_value = "I am actually some value"
print(de.some_value)
